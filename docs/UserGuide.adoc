...
=======
>>>>>>> e8f9973161fa82dc787a2d1b58ecfb25c0526075
=== Contacts
...
Expected Outcome:
    ...
    Reminded Daniel to return $10.00! + Reminded Joel to return $30.75!
...
Expected Outcome:
    ...
    Here is a list of your contacts with name Grace: + 1. Grace Lim + 2. Grace Pan + … 
